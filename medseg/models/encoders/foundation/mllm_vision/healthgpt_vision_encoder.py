...
embed_dim=1024, depth=24, patch_size=14, native input 336x336.
...
Output:
    ...
    (deepest LAST).
"""
# Source: https://github.com/DCDmllm/HealthGPT
...
class HealthGPTVisionEncoder(BaseFoundationEncoder):
    ...
    def __init__(self, in_channels: int = 3, img_size: Optional[int] = None,
        ...
        if pretrained:
            ...
            raise RuntimeError(
                "HealthGPTVisionEncoder does not support pretrained=False. "
