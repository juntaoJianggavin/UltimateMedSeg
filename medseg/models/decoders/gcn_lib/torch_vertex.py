...
try:
    ...
    raise RuntimeError(
        ...
        "Silently disabling DropPath would change the regularisation "
        "behaviour without any user notification."
    ) from e
...
class DyGraphConv2d(GraphConv2d):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=9, dilation=1,
                 ...
                 stochastic=False, epsilon=0.0, r=1, padding=4, groups=4):
...
class Grapher(nn.Module):
    ...
    def __init__(self, in_channels, kernel_size=9, dilation=1, conv='edge',
                 act='relu', norm=None, bias=True, stochastic=False,
                 epsilon=0.0, r=1, n=196, drop_path=0.0,
                 relative_pos=False, padding=4):
        super().__init__()
        ...
        self.graph_conv = DyGraphConv2d(
            ...
            act, norm, bias, stochastic, epsilon, r, padding=padding,
            groups=in_channels)
        ...
        if relative_pos:
            ...
            relative_pos_tensor = F.interpolate(
                relative_pos_tensor, size=(n, n // (r * r)),
